...
const Stars = ({star, setStar}) => {
    ...
    useEffect(() => {
        $(".rating ul li").on("click", function () {
            ...
            if (
                !rating.hasClass("animate-left") &&
                !rating.hasClass("animate-right")
            ) {
        ...
        <Fragment>
            ...
            <div className="content-start">
                <nav className="rating">
                    <ul>
                        <li className={(star == 1)?"current":""}>
                            <svg>
                                <use xlinkHref="#star"></use>
                            </svg>
                        </li>
                        <li className={(star == 2)?"current":""}>
                            <svg>
                                <use xlinkHref="#star"></use>
                            </svg>
                        </li>
                        <li className={(star == 3)?"current":""}>
                            <svg>
                                <use xlinkHref="#star"></use>
                            </svg>
                        </li>
                        <li className={(star == 4)?"current":""}>
                            <span></span>
                            <svg>
                                <use xlinkHref="#star"></use>
                            </svg>
                        </li>
                        <li className={(star == 5)?"current":""}>
                            <span></span>
                            <svg>
                                <use xlinkHref="#star"></use>
                            </svg>
